CREATE VIEW [dbo].[v_PayCal_Pom_BKP_30_07_2025]
...
/*****************************************************************************************************************
	...
	Updated 2025-07-24: SN007: 584528: Addition of Joiner and Leaver columns.
 *****************************************************************************************************************/	
...
,joinerleaver_code		= lods.leaver_code /*** SN007: Added 3 Columns ***/
,lods.leaver_date	
,lods.joiner_date
FROM
rpd.POM p
