CREATE VIEW [dbo].[v_RE_EX_enrolment_report] AS With enrolmentBase as (
/****************************************************************************************************************************
	History:
...
,IsLatestEnrolment			=	Case When Row_Number () over(partition by [FromOrganisation_ReferenceNumber],Persons_Id, SecurityQuery
								...
								End 
  From 
	enrolmentBase					eb    /*** SN001:  enrolementBase replaced src ***/
  Left Join 
	cte_OrganisationFirstPerson		ofp 
		on eb.Organisations_id=ofp.OrganisationID;