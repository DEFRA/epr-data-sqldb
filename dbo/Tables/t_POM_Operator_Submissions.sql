CREATE TABLE [dbo].[t_POM_Operator_Submissions] (
    [Producer_Org_Name]            NVARCHAR (4000) NULL,
    ...
    [organisation_id_producer]     INT             NULL,
