CREATE VIEW [dbo].[v_OrganisationsAndSecurity] AS with cte_Enrolments as (
...
-- select * from cte_OrganisationsAndRolesAndPersonsAndNations


-- Security Query Starts Here
-- -- cte_Security as (
-- --     select Security_Id, FromOrganisation_NationName as SecurityQuery
-- --     from cte_OrganisationsAndRolesAndPersonsAndNations
-- --     union all
-- --     select Security_Id, ToOrganisation_NationName as SecurityQuery
-- --     from cte_OrganisationsAndRolesAndPersonsAndNations
-- -- ),
...
select * from cte_OrganisationsAndSecurity;