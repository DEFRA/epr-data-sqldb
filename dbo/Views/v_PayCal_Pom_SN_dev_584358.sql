CREATE VIEW [dbo].[v_PayCal_Pom_SN_dev_584358] AS WITH latest_accepted_registration AS(
/*****************************************************************************************************************
	History:
	...
	Updated 2025-07-24: SN007: 584358: Addition of Joiner and Leaver columns.
 *****************************************************************************************************************/	
...
, Latest_Org_Data_Selection AS(
								...
								,cd.leaver_code  /*** SN007: Added 3 Columns ***/
								,cd.leaver_date	
								,cd.joiner_date
								FROM rpd.CompanyDetails cd
...
,lods.leaver_code /*** SN007: Added 3 Columns ***/
,lods.leaver_date	
,lods.joiner_date
FROM
rpd.POM p
