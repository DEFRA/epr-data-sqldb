	...
	IF @CS_or_DP = 'All producers'
		BEGIN
			...
			src As (
				Select 
					...
					,Highlighted_liability_cost_flag			= Case 
																	 ...
																	 End
					,reg.RegIsLatest
					,PomIsLatest								= Row_Number() Over(Partition By pom_organisation_id , reg.SubPeriodOrdr ,  pom.pom_subPeriod_ord Order by pom.pom_Created Desc )
				From
					RegFileLtst					reg
			...
			From
				src
			Where
				src.RegIsLatest = 1 And src.PomIsLatest = 1;
