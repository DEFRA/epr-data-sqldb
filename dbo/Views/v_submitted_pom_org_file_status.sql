CREATE VIEW [dbo].[v_submitted_pom_org_file_status]
AS
With
/****************************************************************************************************************************
History: 
...
first_PackagingResubmissionReferenceNumberCreated_entry
as
(
...
(
	...
	from rpd.SubmissionEvents
	where type = 'Submitted' and ISNULL(IsResubmission,0) = 0
),
rank_list_A as
(
	select D.SubmissionId, D.SubmissionEventId, S.fileid as fileid_new
...
get_all_RegistrationApplicationSubmitted
as
(
