CREATE VIEW [dbo].[v_POM_All_Submissions_testbug]
AS With vPOM_AS 
As 
(
	...
	*****************************************************************************************************/
	...
	(
			...
			FROM dbo.t_POM_Submissions_testbug direct  
			WHERE direct.FileName NOT IN ( SELECT DISTINCT operators.FileName 
							FROM dbo.v_POM_Operator_Submissions_testbug operators )
			...
			FROM dbo.v_POM_Operator_Submissions_testbug
