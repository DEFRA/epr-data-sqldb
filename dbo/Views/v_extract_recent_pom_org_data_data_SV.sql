CREATE VIEW [dbo].[v_extract_recent_pom_org_data_data_SV] AS with 
/****************************************************************************************************************************
	History:
	...
	Created: 2025-06-03:    SV001:  Ticket - 561770:    Masterscript - Added field Is_Resubmisiion_Identifier 
******************************************************************************************************************************/
TwoRow as
(
...
(
		...
		(
			select distinct o.id as OrganisationId, cd.organisation_id as ReferenceNumber
					...
					, fs.IsResubmission_identifier -- SV
