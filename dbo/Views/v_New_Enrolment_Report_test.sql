CREATE VIEW [dbo].[v_New_Enrolment_Report_test] AS WITH 
cte_Enrolments_AND_DP AS (
	...
	left join dbo.v_rpd_PersonOrganisationConnections_Active con on e.Enrolment_ConnectionId = con.Id
	left join dbo.v_rpd_Persons_Active p on p.id = con.PersonId
),
