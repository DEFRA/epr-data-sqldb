...
--select * from OrganisationDetailsCTE  where RegistrationSetId = 'db3f3ec1-510f-4aa7-82fb-87a026831d64'
,SubsidiaryCountsCTE
    AS
    (
        SELECT
...
--select * from SubsidiaryCountsCTE where filename = 'c12add81-f5c0-4a0f-aa2d-893267e39db5'
