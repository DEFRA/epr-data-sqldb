...
*/
select distinct pom_cd.SubmissionId, pom_cd.RegistrationSetId, pom_cd.OrganisationId, pom_cd.FileName, pom_cd.FileType, pom_cd.OriginalFileName, pom_cd.TargetDirectoryName, pom_cd.ComplianceSchemeId, pom_cd.Decision_Date, /*pom_cd.Regulator_Status_recalculated as Regulator_Status,*/ pom_cd.Regulator_Status /*as Regulator_Status_old*/, pom_cd.RegulatorDecision, pom_cd.Regulator_User_Name, pom_cd.Regulator_Rejection_Comments, pom_cd.RejectionComments, pom_cd.Type, pom_cd.UserId, pom_cd.RowNumber, pom_cd.Created, TRY_CONVERT(DATETIME, SUBSTRING(pom_cd.Created, 1, 23)) AS CreatedDateTime, pom_cd.Application_submitted_ts, pom_cd.RegistrationType, pom_cd.SubmissionPeriod, TRY_CONVERT(INT, RIGHT(pom_cd.SubmissionPeriod, 4)) AS SubmissionPeriodYear, pom_cd.ApplicationReferenceNo, pom_cd.registrationreferencenumber, pom_cd.Original_Regulator_Status, pom_cd.SubmissionType, pom_cd.IsResubmission_identifier, pom_cd.Is_resubmitted_POM_identifier, pom_cd.cfm_FileId, pom_cd.FileId, pom_cd.fileid_new, pom_cd.submitted_Fileid, pom_cd.SubmissionEventId_of_submitted_record, pom_cd.app_submitted_Fileid, pom_cd.SubmissionEventId_of_application_submitted_record
from cd_pom_result pom_cd
union
select distinct cfm.SubmissionId, cfm.RegistrationSetId, cfm.OrganisationId, cfm.FileName, cfm.FileType, cfm.OriginalFileName, cfm.TargetDirectoryName, cfm.ComplianceSchemeId,cp.Decision_Date, /*cp.Regulator_Status_recalculated as Regulator_Status,*/ cp.Regulator_Status /*as Regulator_Status_old*/,cp.RegulatorDecision, cp.Regulator_User_Name, cp.Regulator_Rejection_Comments, cp.RejectionComments, cp.Type, cp.UserId, cp.RowNumber, cp.Created, TRY_CONVERT(DATETIME, SUBSTRING(cp.Created, 1, 23)) AS CreatedDateTime, cp.Application_submitted_ts, cp.RegistrationType, cp.SubmissionPeriod, TRY_CONVERT(INT, RIGHT(cp.SubmissionPeriod, 4)) AS SubmissionPeriodYear, cp.ApplicationReferenceNo, cp.registrationreferencenumber, cp.Original_Regulator_Status, cp.SubmissionType, cp.IsResubmission_identifier, cp.Is_resubmitted_POM_identifier, cp.cfm_FileId, cp.FileId, cp.fileid_new, cp.submitted_Fileid, cp.SubmissionEventId_of_submitted_record, cp.app_submitted_Fileid, cp.SubmissionEventId_of_application_submitted_record
From rpd.cosmos_file_metadata cfm
