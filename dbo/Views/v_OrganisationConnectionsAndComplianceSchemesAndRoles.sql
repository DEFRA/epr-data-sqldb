CREATE VIEW [dbo].[v_OrganisationConnectionsAndComplianceSchemesAndRoles] AS with cte_Enrolments as (
...
select * from cte_OrganisationConnectionsAndComplianceSchemesAndRoles;