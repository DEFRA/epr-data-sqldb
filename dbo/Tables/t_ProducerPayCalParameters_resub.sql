...
(
    ...
    [FileId]                        UNIQUEIDENTIFIER NULL,      -- cfm.FileId              VERIFY (rpd.cosmos_file_metadata)
    [RegistrationSetId]             UNIQUEIDENTIFIER NULL,      -- cfm.RegistrationSetId   VERIFY (rpd.cosmos_file_metadata)
